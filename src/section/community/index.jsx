...
import blur from "../../assets/Image-9.avif";
import avi from "../../assets/1a-Frame-1000002947.png";
import twitter from "../../assets/X-logo.svg";
import xenu from "../../assets/xenu.png";
import pavol from "../../assets/pavol.png";
import michael from "../../assets/michael.png";
import untraceable1 from "../../assets/untraceable1.png";
import williams from "../../assets/williams.png";
import xenu1 from "../../assets/xenu1.jpg";
    ...
    <div className="w-full md:h-[780px] h-[542px] relative bg-[#090909] overflow-hidden">
      ...
      <div className="md:hidden flex gap-[1rem] px-[1rem] overflow-x-scroll w-[1000px]">
        ...
        <div className="md:grid hidden  grid-cols-[324px_324px_324px] gap-[1rem] relative h-[750px]">
          ...
          <div className="flex flex-col gap-[1rem] -mt-[3.75rem]">
            ...
            <div className="  bg-[#0d0d0d]/60 rounded-[1.25rem] p-[2rem] border border-[#0d0d0d] blur-[4px] ">
              <p className="text-[.875rem] text-[#c2c2c2]">
                This platform is everything a crypto user needs. The interface
                is clean, the fffprocess is smooth, and the privacy features are
                outstanding. The fact that I can trade without worrying about
                hidden fees is a game-changer. I’ll definitely continue using
                it!
              </p>
              <div className=" mt-[1rem] flex justify-between items-center">
                <div className=" flex items-center gap-[.875rem] ">
          ...
          <div className="flex flex-col gap-[1rem] -mt-[3.75rem]">
            ...
            <div className=" bg-[#141414] rounded-[1.25rem] p-[2rem] border border-[#ffffff1f] ">
              <p className="text-[.875rem] text-[#c2c2c2]">
                RetoSwap lays the groundwork for the next significant phase of
                Monero: the growth of its decentralized peer-to-peer exchanges.
              </p>

              <div className="mt-[1rem] flex justify-between items-center">
                <div className=" flex items-center gap-[.875rem] ">
                  <img className="w-[52px] rounded-full" src={xenu} alt="alt" />
                  <div className="flex flex-col text-[#c2c2c2]">
                    <h5 className="text-[.875rem]">James Walker</h5>
                    <h5 className="text-[.875rem]">Somone</h5>
                  </div>
